...
;	DEM_reg_{times}_{pixel_number}.dat
	...
	oploterr, DEM_reg_1.logt, DEM_reg_1.dem*chk_1+1, DEM_reg_1.elogt*chk_1, DEM_reg_1.edem*chk_1, $
	linestyle=0, color=200, errcolor=200, thick=4, errthick=2, /nohat, errstyle=5

	wave_length = [ '12:15:02','12:12:02' ]
	tresp_color = [ 0,200 ]
	...
	write_jpeg, path_to_save + "DEM_reg_pixel_" + string(a, '(I0)') + ".jpg", $
